...
/**
 * Common context shared by all {@link ImporterFactory}s. This allows importers to access common infrastructure, e.g. the {@link ImporterService}.
 */
public class ImporterContext {
	...
	/**
	 * Get the common instance of {@link ImporterService}. Can be used e.g. for delegating to other importers.
	 * 
