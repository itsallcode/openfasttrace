...
/**
 * This represents a file (either physical or virtual as a stream) that can be read by an importer.
 */
public interface InputFile {
	 ...
	 * 
	 * @return <code>true</code> if this {@link InputFile} is based on a real file.
	 */
	boolean isRealFile();

	/**
	 * Get the {@link Path} to the file when {@link #isRealFile()} is <code>true</code>. Else throws an {@link UnsupportedOperationException}.
	 * 
