...
Code name: Transitive Failure Distinction

## Summary

OpenFastTrace now distinguishes between direct and transitive defects in both HTML and plain text reports.
A direct defect is a failure of the item itself, while a transitive failure is inherited from covered items that are failed.
