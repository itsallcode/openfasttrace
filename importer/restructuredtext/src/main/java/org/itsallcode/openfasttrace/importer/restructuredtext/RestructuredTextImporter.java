...
public class RestructuredTextImporter extends LightWeightMarkupImporter
{
    ...
    protected Transition[] configureTransitions()
    {
        ...
        return new Transition[]{
            ...
            transition(SPEC_ITEM  , SPEC_ITEM  , RstPattern.NEEDS_INT  , this::addNeeds                     ),
            transition(SPEC_ITEM  , NEEDS_LINE , RstPattern.NEEDS      , () -> {}                           ),
            ...
            transition(SPEC_ITEM  , START      , RstPattern.FORWARD    , () -> {endItem(); forward();}      ),
            ...
            transition(DESCRIPTION, SPEC_ITEM  , RstPattern.NEEDS_INT  , this::addNeeds                     ),
            transition(DESCRIPTION, NEEDS_LINE , RstPattern.NEEDS      , () -> {}                           ),
            ...
            transition(RATIONALE  , SPEC_ITEM  , RstPattern.NEEDS_INT  , this::addNeeds                     ),
            transition(RATIONALE  , NEEDS_LINE , RstPattern.NEEDS      , () -> {}                           ),
            ...
            transition(COMMENT    , SPEC_ITEM  , RstPattern.NEEDS_INT  , this::addNeeds                     ),
            transition(COMMENT    , NEEDS_LINE , RstPattern.NEEDS      , () -> {}                           ),
            ...
            transition(COVERS     , SPEC_ITEM  , RstPattern.NEEDS_INT  , this::addNeeds                     ),
            transition(COVERS     , NEEDS_LINE , RstPattern.NEEDS      , () -> {}                           ),
            ...
            transition(DEPENDS    , SPEC_ITEM  , RstPattern.NEEDS_INT  , this::addNeeds                     ),
            transition(DEPENDS    , NEEDS_LINE , RstPattern.NEEDS      , () -> {}                           ),
            ...
            transition(NEEDS_LINE , SPEC_ITEM  , RstPattern.ID         , this::beginItem                    ),
            transition(NEEDS_LINE , TITLE      , SECTION_TITLE         , () -> {endItem(); rememberTitle();}),
            transition(NEEDS_LINE , RATIONALE  , RstPattern.RATIONALE  , this::beginRationale               ),
            transition(NEEDS_LINE , COMMENT    , RstPattern.COMMENT    , this::beginComment                 ),
            transition(NEEDS_LINE , DEPENDS    , RstPattern.DEPENDS    , () -> {}                           ),
            transition(NEEDS_LINE , NEEDS_LINE , RstPattern.NEEDS_REF  , this::addNeeds                     ),
            transition(NEEDS_LINE , NEEDS_LINE , RstPattern.EMPTY      , () -> {}                           ),
            transition(NEEDS_LINE , COVERS     , RstPattern.COVERS     , () -> {}                           ),
            transition(NEEDS_LINE , TAGS       , RstPattern.TAGS_INT   , this::addTag                       ),
            ...
            transition(TAGS       , SPEC_ITEM  , RstPattern.NEEDS_INT  , this::addNeeds                     ),
            transition(TAGS       , NEEDS_LINE , RstPattern.NEEDS      , () -> {}                           ),
            transition(TAGS       , SPEC_ITEM  , RstPattern.EMPTY      , () -> {}                           ),
