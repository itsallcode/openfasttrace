...
public abstract class AbstractCommand
{
    ...
    public void start()
    {
        final List<LinkedSpecificationItem> linkedSpecItems = importItemsFromPaths(
                getNormalizedPaths());
        processSpecificationItems(linkedSpecItems);
    }

    private List<LinkedSpecificationItem> importItemsFromPaths(final List<Path> paths)
    {
     ...
     */
    abstract protected void processSpecificationItems(
            List<LinkedSpecificationItem> linkedSpecItems);
}